...
class Theme_Customize_Repeater_Control extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue () {
		wp_enqueue_script('customize-repeater-control',  get_template_directory_uri().'/inc/customize-controls/customize-repeater-control.js', array('jquery', 'customize-controls'), false, true);
	}
