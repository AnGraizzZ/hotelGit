...
class SP_Customizer{
				...
				if(isset($section['fields'])){
					foreach ($section['fields'] as $fields){
						...
						if($fields['type'] == 'input'){
							$sanitize_callback = array($this,'sp_sanitize_text_field');	
						}
						...
						$wp_customize->add_control(new WPCI_Customize_Icon_Control(	$wp_customize,	$fields['name'],	array(
										'type'      => 'icon',
										'label' => $fields['label'],
										'section' => $section['name'],
										//'priority' => 10,
	...
	function sp_sanitize_text_field($input)
	{
		$allowed_html = array(
			'br'     => array(),
		); 
